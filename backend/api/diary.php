...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    try {
        // Check if getting specific entry by date
    ...
    try {
        ...
        $query = "INSERT INTO diary_entries (user_id, content, entry_date, created_at, updated_at) 
                  VALUES (:user_id, :content, :entry_date, NOW(), NOW())";
